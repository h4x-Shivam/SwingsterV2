            ...
            <div className="flex-1 flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-[140px] flex flex-col md:border-l border-white/5 md:pl-8 justify-center gap-6 mt-6 md:mt-0 pt-6 md:pt-0 border-t md:border-t-0">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <a href="#" className="flex items-center gap-3 text-sm text-white/60 hover:text-[#0a66c2] transition-colors">
                  ...
                  <a href="#" className="flex items-center gap-3 text-sm text-white/60 hover:text-emerald-400 transition-colors">
