## Purpose
The scan engine acts as the orchestrator for the SwingsterV2 scanning pipeline, executing trend filtering, volume analysis, pattern detection, relative strength ranking, risk-reward calculation, and final candidate scoring in parallel processes.
## Requirements
